...
--
-- Host: localhost
-- Generation Time: Jul 04, 2023 at 04:37 PM
...
(6, 2, 'Laboratorio Teatrale ', 'Lezioni di teatro e recitazione presso l\'auditorium scolastico.', 150, 12);
...
INSERT INTO `registro_attivita` (`id`, `id_personalescolastico`, `id_studente`, `id_attivita`, `tipo_transazione`, `data_transazione`, `crediti`, `tempo_impiegato`, `durata`) VALUES
(1, 1, 1, 1, 'Assegnazione', '2023-06-26', 5, NULL, 120),
(2, 2, 2, 2, 'Assegnazione', '2023-06-26', 3, NULL, 90),
(3, 3, 3, 3, 'Assegnazione', '2023-06-26', 8, NULL, 180),
(4, 4, 3, 4, 'Assegnazione', '2023-06-26', 6, NULL, 120),
(5, 5, 2, 5, 'Assegnazione', '2023-06-26', 4, NULL, 90);

--
-- Triggers `registro_attivita`
--
DELIMITER $$
CREATE TRIGGER `tempo_impiegato_trigger` BEFORE INSERT ON `registro_attivita` FOR EACH ROW BEGIN
    DECLARE durata_attivita INT;
    SET durata_attivita = (SELECT durata FROM attivita_didattiche WHERE id = NEW.id_attivita);
    
    IF NEW.tempo_impiegato > durata_attivita THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Il tempo impiegato supera la durata dell''attività.';
    END IF;
END
$$
DELIMITER ;
...
--
-- Table structure for table `storico_beni`
--

CREATE TABLE `storico_beni` (
  `id` int(11) NOT NULL,
  `id_bns` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `storico_beni`
--

INSERT INTO `storico_beni` (`id`, `id_bns`, `anno`, `prezzo`) VALUES
(1, 1, 2020, 10),
(2, 1, 2021, 8),
(3, 1, 2022, 15);
...
INSERT INTO `studenti` (`id`, `id_utente`, `id_tutor`, `id_gruppo`, `id_classe`, `nome`, `cognome`, `email`, `password`, `qr_code`, `panzini_coin`, `competenze_assegnate`, `data_registrazione`) VALUES
(1, 6, 1, 1, 1, 'Luca', 'Rossi', 'luca.rossi@gmail.com', 'password123', 0x71725f636f64655f64617461, 100, 'Matematica, Fisica', NULL),
(2, 7, 1, 1, 1, 'Simone', 'Bianchi', 'simone.bianchi@gmail.com', 'securepassword', 0x71725f636f64655f64617461, 80, 'Chimica, Biologia', NULL),
(3, 8, 1, 1, 2, 'Giulia', 'Verdi', 'giulia.verdi@gmail.com', '12345678', 0x71725f636f64655f64617461, 120, 'Anatomia, Geologia', NULL);

--
-- Triggers `studenti`
--
DELIMITER $$
CREATE TRIGGER `tr_studenti_insert` BEFORE INSERT ON `studenti` FOR EACH ROW BEGIN
    SET NEW.data_registrazione = CURDATE();
END
$$
DELIMITER ;
...
INSERT INTO `tutor` (`id`, `id_docente`, `id_gruppo`) VALUES
(1, 1, NULL);
...
ALTER TABLE `amministratore`
  ...
  ADD UNIQUE KEY `unique_email_tabella2` (`email`);
...
ALTER TABLE `docenti`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_email` (`email`),
  ADD UNIQUE KEY `unique_email_tabella1` (`email`),
  ADD KEY `id_personalescolastico` (`id_personalescolastico`);
...
ALTER TABLE `gruppi_competenze`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_id_tutor` (`id_tutor`);
...
ALTER TABLE `personale_scolastico`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_email` (`email`),
  ADD UNIQUE KEY `unique_email_tabella3` (`email`),
...
--
-- Indexes for table `storico_beni`
--
ALTER TABLE `storico_beni`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `tutor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_docente` (`id_docente`),
  ADD KEY `fk_id_gruppo` (`id_gruppo`);
...
--
-- AUTO_INCREMENT for table `storico_beni`
--
ALTER TABLE `storico_beni`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `storico_beni`
--
ALTER TABLE `storico_beni`
  ADD CONSTRAINT `storico_beni_ibfk_1` FOREIGN KEY (`id_bns`) REFERENCES `beni_servizi` (`id`);
...
--
ALTER TABLE `tutor`
  ADD CONSTRAINT `fk_id_gruppo` FOREIGN KEY (`id_gruppo`) REFERENCES `gruppi_competenze` (`id`),
